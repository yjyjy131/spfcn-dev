...
class SlotDetector(object):
    ...
    def __call__(self, bev_image):
        # GPU tensor, RGB 형식 변환 / mark 및 direction head 를 통해 예측된 mark, direction 값 반환
        ...
        # TODO : mark shape ?
        # TODO : 최종 mark prediction 연산 과정
        # TODO : mark, mark_prediction, mark_map, direction, item, distance_map, slot_list
        # mark_map : 예측한 mark 정보 위치 map => mark_map 기반, distance_map 생성

        # 예측된 mark 값 변환
        # threshold 값을 거쳐 True / False Mask 를 생성,
        mark = mark[0, 0]
        ...
        # mark_count x 4 사이즈 mark map 생성 / 하나의 mark 를 4 개 정보로 표현
        # TODO : mark_map : [0, 1, 2, 3] 각 인덱스 정보 의미 ?
